...
sage_graphs = [graphs.Balaban10Cage(), graphs.Balaban11Cage(), graphs.BidiakisCube(), 
...
graphs.MarkstroemGraph(), graphs.McGeeGraph(), graphs.McLaughlinGraph(), graphs.MeredithGraph(), 
...
graphs.SchlaefliGraph(), graphs.ShrikhandeGraph(), graphs.SimsGewirtzGraph(), 
