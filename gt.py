...
#kludge to cache values of built-in chromatic_number
@memoized
def chromatic_num(g):
...
def n_over_alpha(g):
    n = g.order() + 0.0
    return n/g.independence_number()
...
intractable_invariants = [independence_number, domination_number, chromatic_index, Graph.clique_number, clique_covering_number, n_over_alpha, chromatic_num, wilf, brooks]
