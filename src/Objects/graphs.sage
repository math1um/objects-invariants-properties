...
medium_graph_strings = [] #about one line in g6 format
large_graph_strings = [] #anything more two lines

print("Large graphs are no longer loaded at runtime. Their strings are in two lists: large_graph_strings, medium_graph_strings")
...
add_to_lists(truncatedDodecahedral_string, large_graphs_strings)
